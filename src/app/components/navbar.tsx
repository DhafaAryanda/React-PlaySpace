...
export default function Navbar() {
  return (
    <nav className="w-full fixed top-0 bg-[#f0f0f010] dark:bg-[#00000010] backdrop-blur-lg z-10">
      <div className="container max-w-[1130px] mx-auto flex items-center justify-between h-[74px]">
        <div className="flex items-center gap-[26px]">
          ...
          <ul className="flex gap-6 items-center">
            <li className="text-gray-700 dark:text-playspace-grey hover:text-gray-900  dark:hover:text-playspace-light-grey transition-all duration-300">
              <a href="index.html">Home</a>
            </li>
            <li className="text-gray-700 dark:text-playspace-grey hover:text-gray-900  dark:hover:text-playspace-light-grey transition-all duration-300 relative">
              <button
                id="menu-button"
        ...
        <div className="flex gap-6 items-center">
          <a
            href=""
            className="text-gray-700 dark:text-playspace-grey hover:text-gray-900  dark:hover:text-playspace-light-grey transition-all duration-300"
          >
            Log in
          </a>
          <a
            href=""
            className="p-[8px_16px] w-fit h-fit rounded-[12px] text-gray-700 dark:text-playspace-grey border border-gray-300 dark:border-playspace-dark-grey hover:bg-gray-100 dark:hover:bg-[#2A2A2A] hover:text-gray-900 dark:hover:text-white transition-all duration-300"
          >
            Sign up
          </a>
        </div>
