  ...
  return (
    <section className="grow-0 w-[20%] h-screen shadow p-5 space-y-5">
      <div className="space-y-2">
        <div className="uppercase text-xs font-bold ml-1">User</div>
        <Button
          variant={"ghost"}
          asChild
      ...
      <div className="space-y-2">
        ...
        <Button
          ...
          asChild
          className={`w-full justify-start ${
            pathname === "/user/dashboard/manajemen/sewa"
              ? "bg-accent text-accent-foreground"
              : ""
          }`}
        >
          <Link href={"/user/dashboard/manajemen/sewa"}>
        ...
        <Button
          ...
          asChild
          className={`w-full justify-start ${
            pathname === "/user/dashboard/manajemen/konten"
              ? "bg-accent text-accent-foreground"
              : ""
          }`}
        >
          <Link href={"/user/dashboard/manajemen/konten"}>
        ...
        <Button
          ...
          asChild
          className={`w-full justify-start ${
            pathname === "/user/dashboard/manajemen/riwayat-transaksi"
              ? "bg-accent text-accent-foreground"
              : ""
          }`}
        >
          <Link href={"/user/dashboard/manajemen/riwayat-transaksi"}>
        ...
        <Button
          ...
          asChild
          className={`w-full justify-start ${
            pathname === "/user/dashboard/manajemen/buat-transaksi"
              ? "bg-accent text-accent-foreground"
              : ""
          }`}
        >
          <Link href={"/user/dashboard/manajemen/buat-transaksi"}>
        ...
        <Button
          ...
          asChild
          className={`w-full justify-start ${
            pathname === "/user/dashboard/akun"
              ? "bg-accent text-accent-foreground"
              : ""
          }`}
        >
          <Link href={"/user/dashboard/akun"}>
